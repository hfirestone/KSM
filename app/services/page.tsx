...
const team = [
  ...
  },
  {
    ...
    name: "Olivier Ducrey",
    role: "Sports Lawyer",
    bio: "A leading Swiss lawyer specializing in sports and commercial law, advising federations, clubs, athletes, and sponsors on contracts, disputes, and regulatory matters. Ranked among Switzerland's top sports lawyers by Chambers and Legal 500. Has worked with UEFA on several European Championships.",
  ...
  },
  {
    ...
    bio: "Co-Head of Basketball at Excel Sports Management. Graduated from Creighton University School of Law in 2007. Represents a large roster of NBA players including Nikola Jokic, Kris Middleton, Tyler Herro, Derrick White, and Cade Cunningham.",
...
const offerings = [
  ...
  { icon: "⚖️", title: "Legal Protection", desc: "Expert legal review of every contract and dispute, backed by Switzerland's top sports law firm." },
