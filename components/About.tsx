...
const pillars = [
  {
    ...
    desc: "Securing the most lucrative playing contracts across the world's top leagues.",
  },
  {
    title: "Marketing & Brand",
    desc: "Building tailored marketing strategies to maximize your earnings and presence on and off the court.",
  },
  {
    title: "Financial Planning",
    desc: "Strategic wealth management ensuring your earnings are protected and grown throughout your career.",
  },
  {
    title: "Legal Support",
    desc: "Expert sports and commercial law advice from Switzerland's top-ranked sports lawyers.",
  },
];
  ...
  return (
    <section id="about" className="relative overflow-hidden" style={{ background: "var(--navy2)" }}>
      ...
      <div ref={ref} className="max-w-6xl mx-auto px-6 py-28">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-20">
          {/* Left: text */}
          <div className="reveal space-y-5">
            {[
              ...
              <p key={i} className="leading-relaxed font-light text-base" style={{ color: "var(--light)" }}>
                {p}
              </p>
            ))}
          </div>
          ...
          <div className="reveal space-y-4">
            {pillars.map((p) => (
              ...
              >
                <div
                  className="font-barlow-condensed font-bold text-lg tracking-widest uppercase mb-1"
